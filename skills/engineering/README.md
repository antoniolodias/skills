...
- **[strict-review](./strict-review/SKILL.md)** — Comprehensive, opinionated code review using 3 parallel specialist agents (security, tests, architecture). Each finding is numbered so it can be referenced in follow-up conversation.
